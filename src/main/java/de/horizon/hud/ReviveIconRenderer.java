...
public final class ReviveIconRenderer {
    ...
    public static void draw(GuiGraphicsExtractor context, ReviveSource source, int x, int y) {
        switch (source) {
    ...
    private static void drawSpiritMask(GuiGraphicsExtractor context, int x, int y) {
        ...
        context.outline(x + 3, y + 3, 10, 9, 0xFF95A6BC);
    }

    private static void drawBonzoMask(GuiGraphicsExtractor context, int x, int y) {
        ...
        context.outline(x + 3, y + 2, 10, 11, 0xFF0E1016);
    }

    private static void drawPhoenix(GuiGraphicsExtractor context, int x, int y) {
        ...
        context.outline(x + 4, y + 2, 8, 11, 0xFF8B2F12);
    }
}
